...
SYSOBJ = interrupt.o entry.o sys_call_table.o io.o sched.o devices.o sys.o mm.o utils.o hardware.o list.o
...
devices.o:devices.c $(INCLUDEDIR)/devices.h
	gcc -m32 -g  -fno-omit-frame-pointer -ffreestanding -Wall -Iinclude -c -o devices.o devices.c
...
interrupt.o:interrupt.c $(INCLUDEDIR)/interrupt.h $(INCLUDEDIR)/segment.h $(INCLUDEDIR)/types.h
	gcc -m32 -g -fno-omit-frame-pointer -ffreestanding -Wall -Iinclude -c -o interrupt.o interrupt.c
